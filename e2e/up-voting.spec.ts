...
import {createComment, createPost, login, setupE2eTest, signUp,} from "./utils.js";
...
test.describe("Up Voting", ()=> {
    ...
    test("upvoting works on main page", async ({page}) => {
        ...
        const filledUpvoteButton = page.locator(`[data-e2e="upvote"][data-filled="true"]`);
        const filledDownvoteButton = page.locator(`[data-e2e="downvote"][data-filled="true"]`);
    ...
    test("upvoting works on comment in post page", async({page})=> {
        ...
        for(let i = 0; i<2; i++){
            ...
            const filledUpvoteButton = page.locator(`[data-e2e="downvote"][data-filled="true"]`);
            const filledDownvoteButton = page.locator(`[data-e2e="downvote"][data-filled="true"]`);
            await expect(filledUpvoteButton).toHaveCount(1);
